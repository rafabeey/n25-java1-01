...
public class TextoColorido extends Actor
{
   ...
   //Constructor
   public TextoColorido(String texto, int pX, int pY, int tam, Color corTexto,
              Color corFundo)
   {
       mostrarTexto(texto, pX, pY, tam, corTexto, corFundo);
   }
   
   public void mostrarTexto(String texto, int pX, int pY, int tam, 
        Color corTexto, Color corFundo)
   {
       GreenfootImage img = new GreenfootImage ( texto, tam, corTexto,
            corFundo);
       setLocation(pX, pY);
       setImage(img); 
    }
